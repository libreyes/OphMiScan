...
class m130816_102739_refactor extends CDbMigration
{
	public function up()
	{
		$this->dropTable('ophmiscan_scanned_file');
		$this->alterColumn('ophmiscan_document_scan','element_id','int(10) unsigned NULL');
	}

	public function down()
	{
		$this->alterColumn('ophmiscan_document_scan','element_id','int(10) unsigned NOT NULL');
